...
{                                  
    ...
    static class TrainReservation 
    {
        ...
        public TrainReservation(int pnr, String trainNumber, String trainName, String dateOfJourney, String fromPlace, String toPlace) {
            this.pnr = pnr;
        ...
        public String toString() {
            return "PNR: " + pnr + ", Train Number: " + trainNumber + ", Train Name: " + trainName + ", Date of Journey: " + dateOfJourney +  ", From: " + fromPlace + ", To: " + toPlace;
        }
    }
    ...
    public static void main(String[] args) {
        users.add(new User("naresh", "58341"));
    ...
    private static void makeTrainReservation() {
        ...
        TrainReservation reservation = new TrainReservation(pnr, trainNumber, trainName, dateOfJourney, fromPlace, toPlace);
